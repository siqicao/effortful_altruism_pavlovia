...
function roleAssignRoutineBegin(snapshot) {
  return function () {
    ...
    roleAssignComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function rewardExplainRoutineBegin(snapshot) {
  return function () {
    ...
    rewardExplainComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function block_1_costfreeLoopBegin(block_1_costfreeLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  block_1_costfree.forEach(function() {
...
function fixation_costfreeRoutineBegin(snapshot) {
  return function () {
    ...
    fixation_costfreeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function loss_levelRoutineBegin(snapshot) {
  return function () {
    ...
    loss_levelComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function EffortTaskRoutineBegin(snapshot) {
  return function () {
    ...
    EffortTaskComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function effort_evaluationRoutineBegin(snapshot) {
  return function () {
    ...
    effort_evaluationComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function fixation_costRoutineBegin(snapshot) {
  return function () {
    ...
    fixation_costComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
